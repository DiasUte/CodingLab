...
<body>
    ...
    <div class="movieMain" >
        <section class="movieInfoBlock">
          ...
          <br>
          <div class="eachInfoBlock">
            <span class="eachInfoText"><iframe width="100%" height="450px" src="https://www.youtube.com/embed/XwxLwG2_Sxk" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe></span>
          </div>
          <div class="eachInfoBlock">
            <span class="eachInfoText">
                <nav class = "links">
                    <a href="">Смотреть потом</a>
                    <a href="">Трейлер</a>
                    <a href="">Поделиться</a>
                </nav>
            </span>
...
<h1 class = "h-cat">С фильмом Шрек смотрят</h1>
  <div class="wrapper">
